# Homework card image sources

Local files under this directory are cropped/resized for site cards. Canonical credits also appear on `../homework__HEAD__.md`.
...
| `card_m10_ode.jpg` | Generated with SciPy `odeint` / Matplotlib for this site | Original | Site original |
| `card_m11_montecarlo.jpg` | [Wikimedia: Pi 30K.gif](https://commons.wikimedia.org/wiki/File:Pi_30K.gif) (first frame) | nicoguaro | [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/) |
| `card_m12_audio.jpg` | [Wikimedia: Spectrogram-19thC.png](https://commons.wikimedia.org/wiki/File:Spectrogram-19thC.png) | Aquegg | Public domain |
| `card_m13_calculators.jpg` | [Unsplash `photo-1587145820266-a5951ee6f620`](https://images.unsplash.com/photo-1587145820266-a5951ee6f620) | Unsplash contributor | [Unsplash License](https://unsplash.com/license) |
