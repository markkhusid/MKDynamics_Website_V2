...
:::{grid-item-card}
:link: Section_Call_By_Semantics__HEAD__.md
...
:::{grid-item-card}
:link: Section_Cellular_Automata__HEAD__.md
...
:::{grid-item-card}
:link: Section_Computing_Pi__HEAD__.md
...
:::{grid-item-card}
:link: Section_Implicit_vs_Explicit_Loops__HEAD__.md
...
:::{grid-item-card}
:link: Section_Block_Matrices__HEAD__.md
...
:::{grid-item-card}
:link: Section_BLAS_LAPACK__HEAD__.md
