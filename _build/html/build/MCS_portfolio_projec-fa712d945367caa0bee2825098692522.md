...
[^myref_1]: [OpenFlow Switch Specification. (2021). Retrieved from https://www.openflow.org/sdn-resources/openflow-specifications/](https://en.wikipedia.org/wiki/OpenFlow)
[^myref_2]: Apache HTTP Server Project. (2021). Retrieved from https://httpd.apache.org/
