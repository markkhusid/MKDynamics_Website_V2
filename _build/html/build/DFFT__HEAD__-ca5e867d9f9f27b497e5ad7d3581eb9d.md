...
Sine Wave at 10 Hz
^^^
```{figure} images/sine_wave2_10Hz.jpeg
:class: clickable-figure

sine wave2 10Hz
```
```{figure} images/DFFT_mag_sine_wave2_10Hz.jpeg
:class: clickable-figure

DFFT mag sine wave2 10Hz
```
:::

:::{grid-item-card}
:link: Sine_Wave_50_Hz/sine_wave_50_hz.md

Sine Wave at 50 Hz
^^^
```{figure} images/sine_wv_50Hz.png
:class: clickable-figure

sine wv 50Hz
```
```{figure} images/DFFT_sine_wv_50Hz.png
:class: clickable-figure
...
^^^
```{figure} images/sq_wave_1Hz_50pct.jpeg
:class: clickable-figure

sq wave 1Hz 50pct
```
```{figure} images/DFFT_mag_sq_wv2_1Hz_50pct.jpeg
:class: clickable-figure

DFFT mag sq wv2 1Hz 50pct
```
:::
...
^^^
```{figure} images/2_sine_waves_100_Hz_50_Hz.png
:class: clickable-figure

2 sine waves 100 Hz 50 Hz
```
```{figure} images/DFFT_2_sine_waves_100_Hz_50_Hz.png
:class: clickable-figure

DFFT 2 sine waves 100 Hz 50 Hz
```
:::
...
^^^
```{figure} images/switched_sine_wave_1_kHz.png
:class: clickable-figure

switched sine wave 1 kHz
```
```{figure} images/DFFT_switched_sine_wave_1_kHz.png
:class: clickable-figure

DFFT switched sine wave 1 kHz
```
:::
