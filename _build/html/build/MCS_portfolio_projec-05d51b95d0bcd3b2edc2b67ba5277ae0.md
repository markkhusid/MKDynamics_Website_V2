...
The Python Modules Keras [^myref_6] and Tensorflow were the backends that provided the framework for training and testing the Feedforward Neural Networks.
