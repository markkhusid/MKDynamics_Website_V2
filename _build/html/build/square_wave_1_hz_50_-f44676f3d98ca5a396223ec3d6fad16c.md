...
### Time Domain Plot
```{figure} images/scilab_sq_wave_1Hz_50pct.jpeg
:class: clickable-figure

scilab sq wave 1Hz 50pct
```

### Frequency Domain Plot
```{figure} images/scilab_sq_wave_1Hz_50pct_DFFT.jpeg
:class: clickable-figure

scilab sq wave 1Hz 50pct DFFT
```
...
### DFFT Phase Plot
```{figure} images/DFFT_phase_sq_wv2_1Hz_50pct.jpeg
:class: clickable-figure

DFFT phase sq wv2 1Hz 50pct
```
