...
[IppSec Playlists](https://www.youtube.com/channel/UCa6eh7gCkpPo5XXUDfygQQA/playlists)
...
[NetSecNow Main Youtube Channel](https://www.youtube.com/channel/UC6J_GnSAi7F2hY4RmnMcWJw)
...
### NetSecNow (www.PentesterUniversity.org)
[Pentester University website (paid)](https://www.pentesteruniversity.org/)
...
### SecurityTube (paid)
This site is full of excellent computer security / ethical hacking courses. You can even get certifications.  
[Security Tube Training Site (paid)](http://www.securitytube-training.com.s3-website-us-east-1.amazonaws.com/index.html)
...
```{figure} images/gef_screenshot.png
:alt: GEF Screenshot
:align: center
...
```{figure} images/gdb_dashboard_screenshot.png
...
```{figure} images/peda_screenshot.png
:alt: PEDA Screenshot
:align: center
:class: clickable-figure
...
```{figure} images/gdb_dashboard_cyrus.png
