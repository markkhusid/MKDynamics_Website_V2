...
In addition to dealing with categorical data, scaling was necessary to prevent a particular feature from over – biasing the training data.  The SKLearn StandardScaler() class was selected for this operation.  The code cells Perform Feature Scaling on Training Data shows the results:
