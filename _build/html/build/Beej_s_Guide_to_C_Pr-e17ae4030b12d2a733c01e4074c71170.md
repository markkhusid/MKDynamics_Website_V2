...
:alt: Beej's Guide to C Programming
:width: 900px
:align: center
```
## Introduction
...
:::{grid-item-card}
:link: section_6_6_2_arrays_passing_single_dimentsional_arrays_to_functions.ipynb
...
:::{grid-item-card}
:link: section_6_6_3_arrays_passing_single_dimentsional_arrays_to_functions.ipynb
