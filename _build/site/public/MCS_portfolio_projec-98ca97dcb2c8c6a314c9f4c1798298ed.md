...
Once the training and testing data are loaded into Pandas dataframes, they can be filtered for the desired training and testing data based on the three different scenarios as shown in

[Scenario A Train / Test Configuration in Python](#CSE548_Cell_1), 

[Scenario B Train / Test Configuration in Python](#CSE548_Fig_36), [Scenario C Train / Test Configuration in Python](#CSE548_Fig_37):
