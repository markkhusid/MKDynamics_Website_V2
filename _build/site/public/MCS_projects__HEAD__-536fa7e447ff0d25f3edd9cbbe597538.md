...
:::{grid-item-card}
:link: MCS_Portfolio_Project/MCS_portfolio_project.md

MCS Portfolio Project
^^^
```{image} images/MCS_portfolio_project.png
:height: 200
:align: center
```
:::
...
^^^
```{image} images/CSE545_Software_Security.png
:height: 200
:align: center
