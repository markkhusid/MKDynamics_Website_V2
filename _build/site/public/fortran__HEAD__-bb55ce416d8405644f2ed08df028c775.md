...
```{figure} images/fortran_code.jpeg
:alt: fortran_code
:align: center
...
Neural Fortran
^^^
```{figure} images/neural_network.jpg
:height: 300
:class: clickable-figure
...
^^^
```{figure} images/intro_fortran.jpg
:height: 300
:class: clickable-figure
...
^^^
```{figure} images/guide_fortran.jpg
:height: 300
:class: clickable-figure
