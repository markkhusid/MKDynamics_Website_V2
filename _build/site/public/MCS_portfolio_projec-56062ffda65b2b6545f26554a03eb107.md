...
Once the training and testing data are loaded into Pandas dataframes, they can be filtered for the desired training and testing data based on the three different scenarios as shown in [](#CSE548_Fig_35), [](#CSE548_Fig_36), [](#CSE548_Fig_37): Train / Test Configuration in Python:
