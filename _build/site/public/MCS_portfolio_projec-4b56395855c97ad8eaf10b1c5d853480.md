...
Layer 2 firewall rules were also implemented per the Project requirements.  The configuration of the Layer 2 firewall is shown in [](#CSE548_Fig_29): Layer 2 Firewall Rules (rule 3 added) below:
