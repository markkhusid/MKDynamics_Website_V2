...
When examining the provided L3Firewall.py, I noticed that there was a function called:
 ...
 replyToIP(self, packet, match, event, fwconfig), and it contained the logic for processing IP packets.  I therefore decided that the logic to detect a DoS style attack should go into this function.  
