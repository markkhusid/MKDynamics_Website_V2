...
50 Hz sine wave time domain
```

### Frequency Domain Plot (Python-side FFT)

```{figure} images/sine_wv_50Hz_freq_domain.png
:alt: FFT of 50 Hz sine wave from Python
:width: 600px
:class: clickable-figure

FFT of 50 Hz sine wave from Python
```
...
DFFT magnitude of 50 Hz sine wave
```
