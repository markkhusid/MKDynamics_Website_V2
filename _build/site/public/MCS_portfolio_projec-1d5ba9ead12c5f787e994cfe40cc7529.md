...
Of particular interest is how the trained models would perfom when tested on data that is not included in their training data.  To that end, the test data for Scenario A is shown in [](#CSE548_Fig_21): A2 and A4 Testing Dataset Distribution of Attack Types.  We can see that in Scenario A, the model is trained on subclasses A1 and A3 but tested on A2 and A4.  A similar situtation was applied for Scenario B and C.  A distribution of the attacks in the testing data for Scenario B is shown in [](#CSE548_Fig_22): A1 Testing Dataset Distribution of Attack Types.  Similarly, the testing data for Scenario C is shown in Fig 23: A1, A2 and A3 Testing Dataset Distribution of Attack Types.
