...
New firewall rules were added to the Layer 3 and Layer 2 firewall configurations to container filtering rules per the Project instructions.  These are shown in [](#CSE548_Fig_28): Layer 3 Firewall Rules (rules 7 - 11 added) below:
