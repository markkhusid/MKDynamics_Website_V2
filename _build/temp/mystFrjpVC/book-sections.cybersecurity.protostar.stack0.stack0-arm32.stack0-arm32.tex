...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_1_push_r11_-4c2dfed0867225cb68d280b1f50dc587.jpg}
\caption[]{State of execution after \texttt{push r11\_lr}}
\label{GEF_step_1_push_r11_lr.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_2_add_r11_s-5875fd12cf1f48101ede6d111d23fbd5.jpg}
\caption[]{State of execution after \texttt{add r11, sp, 4}}
\label{GEF_step_2_add_r11_sp_4.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_3_sub_sp_sp-ffdbce66e889cbab5bf0d9533131cdea.jpg}
\caption[]{State of execution after sub, sp, 80}
\label{GEF_step_3_sub_sp_sp_80.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_4_str_r0_r1-2f6fd255388a6e43b05e4b397bfe239e.jpg}
\caption[]{State of execution after \texttt{str r0, [r11, 80]}}
\label{GEF_step_4_str_r0_r11_80.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_5_str_r1_r1-de2dad30e9b902a32cef0372a3b1d6f0.jpg}
\caption[]{State of execution after \texttt{str r1, [r11, 84]}}
\label{GEF_step_5_str_r1_r11_84.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_6_mov_r3_0-fcfc4b0cbc8cec029ad307fa5ba07536.jpg}
\caption[]{State of execution after \texttt{mov r3, 0}}
\label{GEF_step_6_mov_r3_0.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/GEF_step_7_str_r3_r1-027845f2fe00f85fb4869814c762fe75.jpg}
\caption[]{State of execution after \texttt{str r3, [r11, 8]}}
\label{GEF_step_7_str_r3_r11_8.jpg}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/exploit_py-8f195edaee4e871abfcd80f9adf20d6e.jpg}
\caption[]{Python program to generate payload to input into \texttt{stack0.c}}
\label{exploit_py_ARM32}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/exploit_py_output_an-a44a5bac8861077d8a50e03293396242.jpg}
\caption[]{Output of \texttt{exploit.py} and \texttt{xxd} view of the payload file}
\label{exploit_py_output_and_xxd_ARM32}
\end{figure}
