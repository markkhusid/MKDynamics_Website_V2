...
Finally, if you need more granular control than that afforded by the abbreviation, you can pass a ValueWidget instance as the argument. A ValueWidget is a widget that aims to control a single value. Most of the widgets \href{https://ipywidgets.readthedocs.io/en/latest/examples/Widget\%20List.html}{bundled with ipywidgets} inherit from ValueWidget. For more information, see this section on widget types.
Also see the \href{https://ipywidgets.readthedocs.io/en/latest/examples/Using\%20Interact.html}{IPyWidgets Interact Documentation} for more general information.
