...
The approach makes use of the BLAS/LAPACK linear equation solver routine called \textbf{SDOT}.  Information on this routine can be found at \href{https://netlib.org/lapack/}{LAPACK - SDOT}.
