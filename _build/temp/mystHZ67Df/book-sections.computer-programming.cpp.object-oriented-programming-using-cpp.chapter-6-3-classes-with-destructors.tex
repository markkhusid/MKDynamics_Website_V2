...
\subparagraph{6.3 Classes with Destructors}

Adapted from: ``Object-Oriented Programming Using C++'' by Ira Pohl (Addison - Wesley)

\subparagraph{Program that demonstrates a class with a destructor in C++}

\subparagraph{In file ch\_stac4.h}
...
\subparagraph{In file ch\_stack4.cpp}
