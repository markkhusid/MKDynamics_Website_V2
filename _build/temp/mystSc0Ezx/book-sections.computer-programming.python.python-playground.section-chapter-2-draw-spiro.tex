...
\subparagraph{Chapter 2: Draw Spiro using Turtle Graphics}
...
\subparagraph{Display the Program Output in Jupyter Lab}
...
\includegraphics[width=0.7\linewidth]{files/1868278292d6a6a215b0459c2e7d6de4.jpeg}