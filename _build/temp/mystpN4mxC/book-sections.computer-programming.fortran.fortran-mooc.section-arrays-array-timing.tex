...
\subparagraph{Section Arrays: Array Timing}
...
\subparagraph{This program demonstrates the different computation times on 2x2 matrices using various Fortran techniques.}
